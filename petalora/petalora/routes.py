def includeme(config):
    ...
    config.add_route('user_list', '/api/user', request_method='GET')  # Optional, admin-only
    ...
    # Order routes
    config.add_route('order_list', '/api/order', request_method='GET')  # Untuk admin & user (lihat order sendiri)
    ...
    # OrderItem routes (bisa dibuat opsional jika akses lewat order)
